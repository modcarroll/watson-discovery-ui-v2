  ...
  search(queryOpts) {
    const params = Object.assign({
      ...
      aggregation:
        ...
        '[term(enriched_text.entities.text).term(enriched_text.sentiment.label),' +
        'term(enriched_text.categories.label).term(enriched_text.sentiment.label),' +
        'term(enriched_text.concepts.text).term(enriched_text.sentiment.label),' +
        'term(enriched_text.keywords.text).term(enriched_text.sentiment.label),' +
        'term(enriched_text.entities.type).term(enriched_text.sentiment.label)]'
    }, queryOpts);
